    ...
    <div class="row border-top px-xl-5">
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                <div class="navbar-nav w-100 ove rflow-hidden" style="height: 410px">
                    @foreach ( $categories as $category )
                    <div class="nav-item dropdown"> 
                        <a href="{{route('front.supcategories',['category_id'=>$category->id])}}" class="nav-link" id="category_id" data-toggle="dropdown">{{$category->name}} </a>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        @else             
                        <li class="nav-item">
                          <a class="nav-item nav-link" href="{{route('cms.login' ,'user')}}">Login</a>
                        </li>                       
                        {{-- <a href="" class="nav-item nav-link">Register</a> --}}
                           <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Register</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="{{route('auth.register')}}" class="dropdown-item">As User</a>
                                <a href="{{route('auth.registervendor')}}" class="dropdown-item">As Vendor</a>
                            </div>
                        </div> 
