            ...
            <div class="row px-xl-5 pb-3">
                ...
                <div  class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right">{{$category->supcategories_count.' '. 'Sub categories'}}</p>
                        <a href="{{route('front.supcategories',['category_id'=>$category->id])}}" class="cat-img position-relative overflow-hidden mb-3">
